...
_query("INSERT INTO
			tb_product (name,pic,variety,area,sort,standard,price,content,stock,date_time)
		VALUES
			(
			'{$_clean['name']}',
			'{$_clean['pic']}',
...
if (_affected_rows() == 1)
					{
					_close();
					_location('恭喜你，添加成功！','db_product_add.php');
}
else
	{
	_close();
	_location('很遗憾，添加失败！','db_product_add.php');
}
